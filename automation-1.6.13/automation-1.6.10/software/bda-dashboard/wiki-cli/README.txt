...
This is a command line interface (CLI) for remotely accessing Confluence using SOAP APIs.
...
- Ensure SOAP is enabled in your Confluence installation
...
- On Windows
  -- Run *confluence*
- On Linux
  -- Run java -jar release/${project.artifactId}-${project.version}.jar
- This will show help text for the command line interface client
- The client defaults to use a user of *automation*.  Either add this user with all the
  authorities required to do the actions you want or specify a different user parameter
- It is recommended that you open the confluence.bat file with an editor and customize
  it for your environment by adding server, user, and password parameters.
  Follow the example in the comments.
