...
import bda.blueprints.common.PropertyReader;

public class ArchitecturalRulesTest extends TestCase {

	PropertyReader propReader = new PropertyReader("default");

	private final String DIRECTORY_TO_ANALYZE = propReader
			.getProperty("classes.directory.jdepend");
	private JDepend jdepend;
	private String dataLayer = "bda.blueprints.business.data";
	private String presentationLayer = "bda.blueprints.web";
	private String businessLayer = "bda.blueprints.business.service";
	private String domainLayer = "bda.blueprints.business.domain";
