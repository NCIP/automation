...
insert into dashboard_properties (dashboard_key, dashboard_value) values('nbia.override.remote.properties','ssh.server.username=bdauser,ssh.server.hostname=localhost,ssh.port=22,ssh.key.file=${user.home}/ssh-pub-key/id_dsa_bda,ssh.dir.temp=${user.home}/remote-deploy,tomcat.ssh.server.username=nbia,tomcat.ssh.server.hostname=localhost,tomcat.ssh.port=22,tomcat.ssh.key.file=${user.home}/ssh-pub-key/id_dsa_bda,tomcat.ssh.dir.temp=${user.home}/remote-deploy,ctp.ssh.server.username=nbia,ctp.ssh.server.hostname=localhost,ctp.ssh.port=22,ctp.ssh.key.file=${user.home}/ssh-pub-key/id_dsa_bda,ctp.ssh.dir.temp=${user.home}/remote-deploy');
